...
<nav class="main-nav">
    ...
    <ul class="ul__second">
        <li class="px-4"><a href="#summer">L'accueil</a></li>
...
<div class="outer-wrapper ">
    <div class="wrapper ">
        ...
        <div id="resume" class="slide two bg-black"></div>
      ...
      fill="#130F26"/>
                    ...
                    <div class="contactForm rounded-lg">
                        ...
                        <div class="formBox">
                            ...
                            <div class="inputBox w50 pt-4">
                                <input type="text" maxlength="10" name="" required>
                                <span>Numéro de téléphone</span>
                            </div>
                            <div class="inputBox w100 pt-4">
                                <textarea class="resize-none" name="" required></textarea>
...
<style>
    ...
    section .container .contactinfo .info li span:nth-child(1) svg {
        max-width: 100%;
        filter: invert(1);
        opacity: 0.5;
    }
    ...
    section .container .contactinfo .info li:hover span:nth-child(1) svg,
    ...
    section .container .contactinfo .sci li a svg {
        filter: invert(1);
        opacity: 0.5;
    }

    section .container .contactinfo .sci li:hover a svg {
        opacity: 1;
    }
